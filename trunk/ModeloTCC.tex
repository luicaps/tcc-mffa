...
% \usepackage {doublespace}		 % para setar espaçamento entre linhas
...
%Estou retirando a dedicatória para posteriori
%\include {iniciais/dedica}
%Estou retirando os agradecimentos, não sei se vou deixar...
